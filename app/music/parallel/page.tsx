...
const Parallel = () => {
  return (
    <div className='pt-16 pb-16 bg-gradient-to-r from-black via-purple-500 to-grey-500 text-white overflow-hidden'>
      <div data-aos='fade-right' data-aos-delay='100' className='w-[80%] mx-auto mt-[12vh] text-3xl font-bold'>
        <h1 className='text-center text-[#00FFFF]'>Parallel Realities</h1>
